...
class ParseInstallation extends ParseObject {
  ...
  Future<void> _updateInstallation() async {
    ...
    set<String>(keyAppName, 'parse');
    set<String>(keyAppVersion, '1.0.16');
    set<String>(keyAppIdentifier, 'parse-sdk');
  ...
  static Future<ParseInstallation> _getFromLocalStore() async {
    ...
    if (installationJson != null) {
      final dynamic installationMap =
          parseDecode(json.decode(installationJson));
